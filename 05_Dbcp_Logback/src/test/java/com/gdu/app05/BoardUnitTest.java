...
/*
	...
	1. 어떤 방식으로 Spring Container에 Bean을 등록했는지 알려주는 역할을 해주는 애너테이션이다.
	2. Bean 등록 방식 3가지
		1) root-context.xml에 <bean> 태그를 추가한 경우
			@ContextConfiguration(locations={"file:src/main/webapp/WEB-INF/spring/root-context.xml"})
			
		2) com.gdu.apqp04.config.AppConfig.java에 @Configuration + @Bean 을 작성한 경우
...
public class BoardUnitTest {
	...
	// BoardUnitTest 클래스를 실행할 때 Logger를 동작시킨다.
	...
	public void a6삭제테스트() {
		...
		assertEquals(1, boardDAO.deleteBoard(board_no)); // board
	}
