...
public class ThirdController {
	...
	// field
	private IThirdService thirdService; //root-context에서 빈을 불러들인다. @Autowired / 생성자 만들기 / setter 형식의 메소드 만들기
	...
	public ResponseEntity<Map<String, String>> ajax2(@RequestBody Map<String, String> map){ // 요청 본문(request body)에 포함된 JSON 데이터를 Contact contact 객체에 저장해 주세요.
