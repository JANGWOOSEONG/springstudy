...
<script>
	...
	function fn1(){
		$.ajax({
												 // 요청 post 타입일 때 JSON.stringify은 세트!!
			type: 'post', 						 // 서버로 보낼 데이터를 요청 본문(request body)에 저장해서 보낸다. 그래서 주소창에서 확인이 안된다.
			...
			contentType: 'application/json', 	 // 서버로 보내는 data의 타입은 서버에 알려준다.
			// 응답
			dataType: 'json',	
