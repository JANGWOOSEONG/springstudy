...
public class AppContext {
	...
	// Bean을 만들고 싶으면 메소드를 만들면 됩니다. (Baen 하나 = 메소드 하나)
 ...
 */
	...
	public Contact contact1() {    // <bean id="contact1" class="Contact">
		...
		c.setFax("02-2222-3333");  // setter <property name = "fax" value = "02-2222-3333"/>
	...
	public Contact www() { // name 속성이 사용되었으므로 메소드명은 더 이상 Bean의 id가 아니에요. 아무 이름이나 써도 된다. 사용하지 않을거니까
		return new Contact("02-111-1111", "02-111-2222");	   
	}
	
	@Bean(name="user2")  // name 속성이 추가되면 Bean의 id로 사용됩니다.
	public User aaa() {	 // name 속성이 사용되었으므로 메소드명은 더 이상 Bean의 id가 아니에요. 아무 이름이나 써도 된다. 사용하지 않을거니까		
		return new User("아이언맨", www());	
	}
